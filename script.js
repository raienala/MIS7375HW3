...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function validateInsurance() {
        insuranceError.textContent = ""; // Clear previous error
    ...
    function validateGender() {
        genderError.textContent = ""; // Clear previous error
    ...
    function validateVaccinated() {
        vaccinatedError.textContent = ""; // Clear previous error
